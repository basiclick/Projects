...
namespace CCSVolunteerMVC.Controllers
{
    public class HoursWorkedController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "hoursWorkedID,posID,hrsWrkdIDType,hrsWrkdTimeIn,hrsWrkdTimeOut,userAcctID,modifiedOn,hrsWrkedSchedDate,volID,volGrpID,hrsWrkdQty")] HoursWorked hoursWorked)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "hoursWorkedID,posID,hrsWrkdIDType,hrsWrkdTimeIn,hrsWrkdTimeOut,userAcctID,modifiedOn,hrsWrkedSchedDate,volID,volGrpID,hrsWrkdQty")] HoursWorked hoursWorked)
        {
            if (ModelState.IsValid)
            {
